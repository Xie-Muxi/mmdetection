...
# To replace the get_uncertain_point_coords_with_randomness and point_sample functions in detectron2/projects/PointRend/point_rend/point_features.py
# ----- The two functions below are modified from "https://github.com/facebookresearch/detectron2/blob/ffff8acc35ea88ad1cb1806ab0f00b4c1c5dbfd9/projects/PointRend/point_rend/point_features.py". -----
...
class SetCriterion(nn.Module):
    ...
    # Override functions according to the specifications of mmdet.
    def __init__(
        self,
        num_classes,
        assigner,
    ...
    def forward(self, outputs, targets):
        ...
        num_masks = reduce_mean(num_masks).clamp_(min=1).item()
